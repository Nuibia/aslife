<template>
  <div class="commentConatiner">
    ...
    <div class="postCmt">
      <p>
        <span>发表我的观点</span>
        <span @click="postcmd">发送</span>
      </p>
      <textarea rows="3" class="txtMsg" v-model="msg" placeholder="优质的观点将在前排展示"></textarea>
    </div>
  </div>
</template>
<script>
    ...
    postcmd(){
      if(this.msg.length>0){
        this.$ajax({
          ...
          //如果post请求正确响应了，我们就可以直接把新发表的评论组织成一个对象，然后添加到list数组中
